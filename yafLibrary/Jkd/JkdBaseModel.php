...
class JkdBaseModel extends BaseModel
{
     ...
     * 获取缓存数据.
     *
     * @param int|string $foreignValue //外键值
     * @param string $whereKey //条件key
     * @param int|string $whereValue //条件值
     * @return array|mixed|string
     */
    public function getCache($foreignValue = '', string $whereKey = '', $whereValue = '')
    {
        if (! $this->isCache) {
            return '';
        }
     ...
     * @return mixed|string
     */
    private function getVo($redis, $foreignWhere)
    {
     ...
     * @return array|mixed|string
     */
    private function getVoList($redis, $foreignWhere, string $whereKey = '', $whereValue = '')
    {
